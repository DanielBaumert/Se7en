...
namespace Se7en.AI {
    ...
    public class NeuralNetwork {
        ...
        /// </param>
        public NeuralNetwork(int numberOfInputNeurons, double learningRate = 2.95) {
        ...
        /// </summary>
        public void PushInputValues(double[] inputs) => _layers.First().Neurons.ForEach(x => x.PushValueOnInput(inputs[_layers.First().Neurons.IndexOf(x)]));

        /// <summary>
        /// Set expected values for the outputs.
        /// </summary>
        public void PushExpectedValues(double[][] expectedOutputs) => _expectedResult = expectedOutputs;
        ...
        private void CreateInputLayer(int numberOfInputNeurons) {
            var inputLayer = _layerFactory.CreateNeuralLayer(numberOfInputNeurons, new RectifiedActivationFuncion());
        ...
        /// </param>
        private void HandleOutputLayer(int row) => _layers.Last().Neurons.ForEach(neuron => {
