...
namespace Se7en.AI {
    public class Neuron : INeuron {
        ...
        /// </returns>
        public double CalculateOutput() => _activationFunction.CalculateOutput(_inputFunction.CalculateInput(Inputs));
        ...
        /// </param>
        public void PushValueOnInput(double inputValue) => ((InputSynapse)Inputs.First()).Output = inputValue;
    }
}
