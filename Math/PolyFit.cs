...
namespace Se7en.Math
{
    ...
    public struct PolyFit
    {
        ...
        /// </summary>
        public MemoryList<double> Coeff { get; private set; }
        ...
        public unsafe MemoryList<double> Fit(MemoryList<double> x)
        {
            MemoryList<double> y = new MemoryList<double>(x.Count);
            MemoryList<double> tmpCoeff = Coeff;
