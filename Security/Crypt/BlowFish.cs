...
namespace Se7en.Security.Crypt
{
    public class BlowFish
    {
        ...
        public string Encrypt_ECB(string pt) => ByteToHex(Encrypt_ECB(Encoding.ASCII.GetBytes(pt)));
        ...
        public string Decrypt_ECB(string ct) => Encoding.ASCII.GetString(Decrypt_ECB(HexToByte(ct))).Replace("\0", "");
        ...
        /// <returns>Plaintext</returns>
        public byte[] Decrypt_ECB(byte[] ct) => Crypt_ECB(ct, true);
