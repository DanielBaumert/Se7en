...
namespace Se7en.UI {
    ...
    public class SmoothLine : Panel {
        ...
        private FadeColor[] _colors;

        public FadeColor[] Colors {
            get => _colors;
            set {
                if (_colors != value) {
                    _colors = value;
        ...
        public SmoothLine() {
            ...
            Colors = new FadeColor[] {
                new FadeColor( Color.Transparent,0),
                new FadeColor( Color.DodgerBlue, 0.5f),
                new FadeColor( Color.Transparent,  1f)
            };
        }
