...
namespace Se7en.Windows
{
    public static class SystemInformation
    {
        ...
        /// </summary>
        public unsafe static bool DragFullWindows {
            get {
                int data;
                User32.SystemParametersInfo(SPI.SPI_GETDRAGFULLWINDOWS, 0,  &data, 0);
                return data != 0;
            }
        }
        /// <summary>
        ...
        /// </summary>
        public unsafe static Rect WorkingArea {
            get {
                Rect rc;
                User32.SystemParametersInfo(SPI.SPI_GETWORKAREA, 0, &rc, 0);
                return rc;
            }
        }
        /// <summary>
        /// Determines whether a screen review utility is running. TRUE for on, or FALSE for off.
        /// </summary>
        public unsafe static bool ScreenReader {
            get {
                bool rc;
                User32.SystemParametersInfo(SPI.SPI_GETSCREENREADER, 0, &rc, 0);
                return rc;
            }
            
            set => User32.SystemParametersInfo(SPI.SPI_SETSCREENREADER, value, null, 0);
        }
        ...
        /// </summary>
        public static Vector2i DragSize => new Vector2i(User32.GetSystemMetrics(SystemMetric.SM_CXDRAG), User32.GetSystemMetrics(SystemMetric.SM_CYDRAG));
